							...
							<div class="row">
								<div class="px-4">
									<form method="POST" action="{{ route('a.personal.store') }}" enctype="multipart/form-data" id="imgform"> @csrf @method('POST')
										<div id="profileDiv" style="height: 100px;width: 100px;border: 1px dashed lightgrey;">
											...
											<img src="{{ asset('storage/profileimages/admin/'.$admin01[0]['profile']) }}" alt="No image" class="profileimg" width="100" height="100">
											<div class="hoverabletext">
												<a href="#" class="imgtext fas fa-camera"></a>
											</div><br>
										</div>
										<div class="d-flex justify-content-center">
											<button class="text-primary btn btn-sm pointer mt-2" name="profileBtn" id="uploadImg" value="1">Upload</button>
										</div>
								...
								<div class="col-lg">
									...
									<div class="form-group">
										...
										<input type="text" id="name" name="name" class="form-control @error('name') is-invalid @enderror" placeholder="Name" value="{{$admin01[0]['name']}}">
										@error('name')
								...
								<div class="col-lg">
									<div class="form-group">
										...
										<input type="email" id="email" name="email" class="form-control @error('email') is-invalid @enderror" placeholder="Email" value="{{$admin01[0]['email']}}">
										@error('email')
										<span class="invalid-feedback" role="alert">
											<strong>{{ $message }}</strong>
										</span>
							...
							<div class="row">
								<div class="col-md-4">
									<div class="form-group">
										...
										<input type="text" id="contactno" name="contactno" class="form-control @error('contactno') is-invalid @enderror" placeholder="Contact" value="{{$admin01[0]['mobileno']}}">
										@error('contactno')
										<span class="invalid-feedback" role="alert">
											<strong>{{ $message }}</strong>
										</span>
