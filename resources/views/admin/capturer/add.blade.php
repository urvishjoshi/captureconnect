...
<div class="container pt-3 px-3">
    <div class="row">
        ...
        <div class="col-md text-center">
            <h2 class="mb-0">Add a Capturer</h2>
        </div>
    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header bg-secondary">Register for Capturer</div>

                <div class="card-body">
                    <form method="POST" action='{{ route("a.capturers.store") }}' aria-label="{{ __('Register') }}">
                        @csrf @method('POST')
