...
<div class="container pt-3 px-3">
    <div class="row">
        <div class="col-md-1 d-flex align-items-start flex-column">
            <a href="{{ route('a.users.index') }}" class="fas fa-arrow-left pt-3 pl-2" style="font-size: 30px;text-decoration:none; "></a>
        </div>
        <div class="col-md text-center">
            <h2 class="mb-0">Add a User</h2>
        </div>
    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header bg-primary">Register for User</div>

                <div class="card-body">
                    <form method="POST" action='{{ route("a.users.store") }}' aria-label="{{ __('Register') }}">
                        @csrf @method('POST')
